...
> 上图由 `chart.py` 每天自动重画，**画什么形式取决于攒了多少天数据**：
>
> | 已采集天数 | 图的形式 |
> |---|---|
> | 1 天 | 柱状图：各品类中位 star（还没有基线） |
> | 2 天 | 柱状图：当日各品类新增 star |
> | **3 天以上** | **小倍数折线趋势图，一格一个品类** |
>
> 折线需要 2 个对比点，而第 1 天没有基线可对比 —— 所以最早第 3 天才有趋势线。
> 第 2 天降级成当日新增的柱状图，那其实已经是真正的信号了，只是还没有第二个点来体现变化。
>
...
- **趋势图需要时间**。折线要 2 个对比点，得采集满 3 天。之前会降级成柱状图
